...
//Route cho trang Blogs
    ...
    Route::group(['prefix' => 'blog', 'middleware' => ['auth', 'admin']], function () {
        ...
        Route::get('/update/{id}', 'BlogController@update')->name('blog.update');
        Route::post('/edit/{id}', 'BlogController@edit')->name('blog.edit');

        Route::get('/create', 'BlogController@create')->name('blog.create');
        Route::get('/del/{id}', 'BlogController@delete')->name('blog.del');

        Route::get('/category', 'BlogCategoryController@index')->name('blog.category.index');
        Route::get('/category/create', 'BlogCategoryController@create')->name('blog.category.create');
        Route::post('/category/store', 'BlogCategoryController@store')->name('blog.category.store');
        Route::get('/category/edit/{id}', 'BlogCategoryController@edit')->name('blog.category.edit');
        Route::post('/category/{id}/update', 'BlogCategoryController@update')->name('blog.category.update');
        Route::get('/category/delete/{id}', 'BlogCategoryController@delete')->name('blog.category.delete');

        Route::get('/tags', 'BlogTagsController@index')->name('blog.tags.index');
        Route::get('/tags/create', 'BlogTagsController@create')->name('blog.tags.create');
        Route::post('/tags/store', 'BlogTagsController@store')->name('blog.tags.store');
        Route::get('/tags/edit/{id}', 'BlogTagsController@edit')->name('blog.tags.edit');
        Route::post('/tags/{id}/update', 'BlogTagsController@update')->name('blog.tags.update');
        Route::get('/tags/delete/{id}', 'BlogTagsController@delete')->name('blog.tags.delete');
    });
