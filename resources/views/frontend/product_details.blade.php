                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="product-description-wrapper">
                            ...
                            {{-- <ul class="breadcrumb">
                                ...
                                <li><a href="{{ route('products.subcategory', $detailedProduct->subcategory->slug) }}">{{ $detailedProduct->subcategory->name }}</a></li>
                                <li class="active"><a href="{{ route('products.subsubcategory', $detailedProduct->subsubcategory->slug) }}">{{ $detailedProduct->subsubcategory->name }}</a></li>
                            </ul> --}}
                            <div class="row align-items-center my-1">
                                <div class="col-6">
                                    ...
                                    <div class="rating">
                                        ...
                                        <span class="rating-count ml-1" style="top:0;">({{ $total }} {{__('customer reviews')}})</span>
                                    </div>
                                </div>
                            ...
                            <div class="d-table width-100 mt-3">
                                <div class="d-table-cell">
                                    ...
                                    @if(Auth::check() && \App\Addon::where('unique_identifier', 'affiliate_system')->first() != null && \App\Addon::where('unique_identifier', 'affiliate_system')->first()->activated && \App\AffiliateOption::where('type', 'product_sharing')->first()->status && Auth::user()->affiliate_user != null && Auth::user()->affiliate_user->status)
                                        @php
                                            if(Auth::check()){
                            ...
                            @if ($refund_request_addon != null && $refund_request_addon->activated == 1)
                                <div class="row no-gutters mt-3">
                                    <div class="col-2">
                                        <div class="product-description-label alpha-6">{{__('Refund')}}:</div>
                                    </div>
                                    <div class="col-10">
